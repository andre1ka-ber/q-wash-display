...
// Logged in once on the kiosk device — the rotating refresh token keeps
// the session alive indefinitely afterward (PLAN.md's "Auth" decision,
// following pegasus-board's already-proven unattended-screen pattern), so
// this screen is only ever seen once per physical device, not per shift.
    ...
    >
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
          ...
          <div style={{ fontFamily: font.display, color: color.textPrimary, fontSize: 20 }}>Экран очереди</div>
        </div>
